...
public class GameControl : MonoBehaviour {
    ...
    void Update()
    {
        if (playerReference != null)
        {
            ...
            waypoints[0].position = playerReference.position + new Vector3(50, 0, 0);
            //NavMesh.FindClosestEdge(playerReference.position + new Vector3(-50, 0, 0), out hit, NavMesh.AllAreas);
            waypoints[1].position = playerReference.position + new Vector3(-50, 0, 0);
            //NavMesh.FindClosestEdge(playerReference.position + new Vector3(0, 0, 50), out hit, NavMesh.AllAreas);
            waypoints[2].position = playerReference.position + new Vector3(0, 0, 50);
            //NavMesh.FindClosestEdge(playerReference.position + new Vector3(0, 0, -50), out hit, NavMesh.AllAreas);
            waypoints[3].position = playerReference.position + new Vector3(0, 0, -50);
        ...
        if (spawnedEnemies >= currentLevelInfo.sizesOfWaves[currentWave] && enemies.Count == 0)
            NextWave();
    }
